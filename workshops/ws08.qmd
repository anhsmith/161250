...
In a two-factor experiment, one of the factors was assigned to main plot (main-plot factor), the second factor, called the subplot factor, was assigned into subplots.  The dataset `https://www.massey.ac.nz/~kgovinda/data/plots.RData` gives the experimental set up. 
...
Perform the ANOVA for this basic split-plot experiment.
```{r, results='hide', fig.show='hide'}
