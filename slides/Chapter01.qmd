...
## Data Collection: Census, Survey & Experiments

-   In a **census**, every element of the population is contacted, counted, and other information collected or evaluated.

-   In a **survey**, data is collected from a *sample* of the population. A sample is a subset of the larger population of interest.

-   **Experiments** are a special type of data collection which involves actively applying a *treatment* to a sample; some variable (drug, temperature, exercise regime, or other treatment) has been manipulated to study its effects.
...
-   Indirect measures
    ...
    -   For example, is Body Mass Index (BMI) a good measure of fitness?
...
-   We randomise data collection to avoid **bias**. If we (consciously or subconsciously) tended to chose the largest fish for our sample, we'd get an upwardly biased estimate of the lengths.

-   *EPSEM* (equal probability of selection) is the simplest way of random sampling.
...
-   Volunteers
    -   e.g. Blood donors...
    -   randomisation?
-   Haphazard / opportunistic / snowball / purposive
