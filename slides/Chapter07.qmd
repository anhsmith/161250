...
-   Look for the predictors having the largest correlation with response
    ...
    -   Try
        <https://shiny.massey.ac.nz/kgovinda/demos/explore.multiple.numerical.variables/>
...
```{r}
# url1 <- "http://www.massey.ac.nz/~kgovinda/data/pinetree.RData"
...
-   Try
    <https://shiny.massey.ac.nz/kgovinda/demos/explore.collinearity/>
...
-   $R^2_{adj}=1-\frac{MS~Error}{MS~Total}$
    ...
    -   Try
        <https://shiny.massey.ac.nz/kgovinda/demos/demo.RSq.and.adjusted.RSq/>
...
-   Avoid over-fitting.
    ...
    -   Try
        <https://shiny.massey.ac.nz/kgovinda/demos/demo.over-fitting.model/>
...
```{r, results='hide'}
# url1 <- "http://www.massey.ac.nz/~kgovinda/data/suppressor.RData"
...
<https://shiny.massey.ac.nz/kgovinda/demos/explore.multiple.regression/>
...
<http://shiny.massey.ac.nz/kgovinda/demos/explore.multiple.regression/>

<http://shiny.massey.ac.nz/kgovinda/demos/fit.multiple.regression/>

<http://shiny.massey.ac.nz/kgovinda/demos/explore.collinearity/>

<http://shiny.massey.ac.nz/kgovinda/demos/explore.Cooks.distances.and.leverages/>

<http://shiny.massey.ac.nz/kgovinda/demos/demo.RSq.and.adjusted.RSq/>
