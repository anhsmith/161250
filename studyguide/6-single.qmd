...
# Chapter 6: Models with a Single Continuous Predictor
...
Model improvement will take place to capture all the systematic variation in the data. This chapter considered only straight line models. If the fit is poor, a transformation could be tried by stretching or shrinking $Y$ by a power transformation.
